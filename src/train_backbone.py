...
def parse_args():
    ...
    parser.add_argument('--batchsize', type=int, help='batch size', default=4) # earlier it was 8, I made it 4
...
if __name__ == '__main__':
    ...
    for epoch in range(config.num_epoch):
        ...
        log.write_to_board(f"Metric", {"ICC": icc_, "kappa":kappa_[0], "pk": pk_}, epoch)
        
        total_metric = icc_ + kappa_[0] - loss_epoch_val
        # if epoch % 5 == 0:
